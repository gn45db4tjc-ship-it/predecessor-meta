# 2.34.2 — whole first item on an iPhone's first screen
...
App version and service-worker shell cache advance together to 2.34.2. The permanent offline data cache, saved selections, settings and statistics are unchanged. Publication and Windows installation remain separate approvals.
