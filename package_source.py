"""Package and independently verify the source-only 2.22.0 release."""
import argparse
import hashlib
import json
import re
...
FILES += ['RELEASE-2.21.8.md','mobile.js','mobile.css','RELEASE-2.22.0.md','app.webmanifest','sw.js','assets/app-icon-192.png','assets/app-icon-512.png']
...
def package(node=None):
    ...
    manifest = {'version':'2.22.0','hosting_revision':6,'design_revision':2,
                'baseline_commit':'cfb96ba7e817d6ae3dbfe3c642a95832f299f1de',
                'verification_report':'RELEASE-2.22.0.md','files':hashes}
    (ROOT / 'SOURCE-MANIFEST.json').write_bytes((json.dumps(manifest,indent=2)+'\n').encode('utf8'))
    archive = ROOT.parent / 'Predecessor Meta Tool 2.22.0 - Source.zip'
